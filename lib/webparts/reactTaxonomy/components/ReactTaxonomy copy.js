...
var ReactTaxonomy = /** @class */ (function (_super) {
    ...
    function ReactTaxonomy(props) {
        ...
        _this.onDivisionChange = function (ev, option) {
            _this.setState({ divisionSelect: option.key });
        };
        sp.setup({
        ...
        return (React.createElement("div", { className: styles.reactTaxonomy },
            React.createElement("div", { className: styles.container },
                React.createElement("div", { className: styles.row },
                    React.createElement(TaxonomyPicker, { allowMultipleSelections: false, initialValues: this.state.divisionTag, termsetNameOrID: "Divisions", panelTitle: "Select Division", label: "Division", context: this.props.context, onChange: this.onDivisionTaxPickerChange, isTermSetSelectable: false })),
                ...
                React.createElement("br", null),
                React.createElement("div", { className: styles.row },
                    React.createElement(TaxonomyPicker, { allowMultipleSelections: false, initialValues: this.state.officeTag, termsetNameOrID: this.state.division, panelTitle: "Select Office", label: "Office", context: this.props.context, onChange: this.onOfficeTaxPickerChange, isTermSetSelectable: false })),
                React.createElement("br", null),
                React.createElement("br", null),
                React.createElement("div", { className: "col" },
                    React.createElement("h5", null, "Enter Details")),
                React.createElement("div", { className: "col" },
                    React.createElement("input", { type: "text", "aria-label": "text details", className: "form-control", placeholder: "Enter Text", id: "textdetails" })))));
    };
    /*
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1: return [2 /*return*/, _a.sent()]; //getById(1).update(data);
                }
            });
        });
    };
...
//# sourceMappingURL=ReactTaxonomy%20copy.js.map